...
public class ChatBoxActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cometChat = CometChat.getInstance(ChatBoxActivity.this);
        setUpFields();
            ...
            if (apiKey != null && !TextUtils.isEmpty(apiKey)) {
                ...
                cometChat.initializeCometChat("", licenseKey, apiKey, isCometOnDemand, new Callbacks() {
                    ...
                    public void successCallback(JSONObject jsonObject) {
                        ...
                        Toast.makeText(ChatBoxActivity.this, "CometChat initialized successfully", Toast.LENGTH_LONG).show();
                    ...
                    public void failCallback(JSONObject jsonObject) {
                        ...
                        Toast.makeText(ChatBoxActivity.this, "Initialize Failed with error: " + jsonObject.toString(), Toast.LENGTH_LONG).show();
                        showLoading(false);
                    }
                });
            } else {
                Toast.makeText(ChatBoxActivity.this, "API Key cannot be null or empty", Toast.LENGTH_LONG).show();
            }
        } else {
            Toast.makeText(ChatBoxActivity.this, "License Key cannot be null or empty", Toast.LENGTH_LONG).show();
        }
    ...
    private void login(String UID) {
        if (UID != null && !TextUtils.isEmpty(UID)) {
            showLoading(true);
            cometChat.loginWithUID(ChatBoxActivity.this, UID, new Callbacks() {
                @Override
                public void successCallback(JSONObject jsonObject) {
                    Log.d(TAG, "Login Success : " + jsonObject.toString());
                    Toast.makeText(ChatBoxActivity.this, jsonObject.toString(), Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(ChatBoxActivity.this, "UID be null or empty", Toast.LENGTH_LONG).show();
        }
    ...
    private void launchChat() {
        ...
        cometChat.launchCometChat(ChatBoxActivity.this, true, new LaunchCallbacks() {
            @Override
            public void successCallback(JSONObject jsonObject) {
